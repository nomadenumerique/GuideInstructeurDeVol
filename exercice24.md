...
Objectifs : + utilisation des diff&eacute;rents instruments
pour d&eacute;terminer     l'assiette de l'a&eacute;ronef

   + utilisation des aides radio &agrave; la navigation




R&eacute;f&eacute;rences : GIV R&eacute;vision d'&eacute;bauche
1990

[Orientation and disorientation in aviation](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3710190/)
   MP 163

   Les instruments de bord,  Modulo Editeur

   Van Sickle  330-373;  467-496;  502-503;  534;
 623-645

   AOPA Flt Training  19-1 &agrave; 19-34
...
## Motivation : l'habilet&eacute; de l'&eacute;tudiant
...
de vol de nuit et/ou de vol aux instruments.



Au sol :

Aides : + Manuel de l'avion 3-5 &agrave; 3-6; 3-8

     POH  3-7; 3-11&agrave; 3-12;  7-22 &agrave;
7-33
...
Facteurs humains :
 ...
 + limitations des sens :
  ...
  la vue:
   ...
   - l'oeil humain est fait de telle fa&ccedil;on
...
instruments.
   ...
   - utiliser les accoudoirs et &eacute;viter les
mouvements de la   t&ecirc;te

   - anticipation des indications &agrave; lire et
lecture erronn&eacute;e

  l'appareil vestibulaire :

   - sensible aux acc&eacute;l&eacute;rations lin&eacute;aires,
dont la gravit&eacute;

   - sensible aux acc&eacute;l&eacute;rations angulaires
(rotationnelles)

  sensations musculaires :

   - surtout sensible aux acc&eacute;l&eacute;rations
dans le plan vertical 

 + d&eacute;sorientation :

  illusions visuelles :

   - faux horizon (couche nuageuse en pente)

   - la nuit, mouvement autocin&eacute;tique

   - feux stroboscopiques dans nuages ou soleil &agrave;
travers     h&eacute;lice au ralenti

  illusions vestibulaires :

   - illusion d'&ecirc;tre encore inclin&eacute;
dans la m&ecirc;me direction que    le mouvement initial

   - illusion d'&ecirc;tre inclin&eacute; dans la
direction oppos&eacute;e que le    mouvement initial

   - illusion de tangage (en piqu&eacute; et en cabr&eacute;)

   - ph&eacute;nom&egrave;ne de Coriolis :  perte
...
Les mouvements de la t&ecirc;te doivent &ecirc;tre graduels, 
  ...
  illusions musculaires :
   ...
   - analogie :  voiture virant &agrave; droite &agrave;
plat, ou en ligne     droite sur une route inclin&eacute;e

   - sensation d'&ecirc;tre inclin&eacute; dans la
direction oppos&eacute; pendant    un d&eacute;rapage

   - sensation de mont&eacute;e prononc&eacute;e
&agrave; l'aac&eacute;l&eacute;ration au d&eacute;c.

   - sensation de mont&eacute;e pendant un virage

   - sensation de piqu&eacute; pendant la sortie
de virage

   - sensation de piqu&eacute; apr&egrave;s la ressource
d'un piqu&eacute;
 ...
 + stress et perturbations &eacute;motionnelle
 ...
 + bruit, &eacute;clairage, vibrations
...
Termes de base :
 ...
 + fixit&eacute; et pr&eacute;cession gyroscopiques

 + vitesse indiqu&eacute;e

 + vitesse vraie

 + vitesse corrig&eacute;e

 + altitude vraie

 + altitude indiqu&eacute;e
...
R&ocirc;le, source de fonctionnement, limites, erreurs
et v&eacute;rification de leur bon fonctionnement

 + installations an&eacute;mom&egrave;triques :

  - altim&egrave;tre barom&eacute;trique
...
Technique de balayage visuel radial s&eacute;lectif
 :

 - 2 importants principes :

  - ne pas rester &quot;fix&eacute;&quot; sur un
instrument

  - toujours retourner &agrave; l'horizon artificiel
apr&egrave;s avoir v&eacute;rifi&eacute;    chacun des autres
instruments

 - r&eacute;p&eacute;ter ces 3 mots :  &quot;assiette
- altitude - cap&quot; mentalement pour   aider &agrave; guider
le balayage des yeux  (coups d'oeil successifs sur   chaque instrument)

 - ce balayage se poursuit pendant tout le vol

 - acc&eacute;l&eacute;rer la vitesse du balayage
avec l'ampleur de la manoeuvre    (anticiper les indications des
instruments)

 - &agrave; chaque dixi&egrave;me cycle de balayage,
inclure l'instrument de radio-         navigation utilis&eacute;

 - &agrave; toutes les deux minutes, inclure tous
les instruments, incluant les   instruments moteurs, la succion
et l'amp&egrave;rem&egrave;tre

 - apr&egrave;s avoir quitt&eacute; des yeux les
instruments de vol, reprendre le    balayage en retournant d'abord
&agrave; l'horizon artificiel


TROIS groupes d'instruments :

 + contr&ocirc;le du tangage :
 ...
 + contr&ocirc;le de l'inclinaison lat&eacute;rale
:
 ...
 + contr&ocirc;le de la puissance :

  - tachym&egrave;tre (ou manom&egrave;tre de pression
d'admission)


TROIS r&egrave;gles de base lorsqu'on commence &agrave;
apprendre le vol aux instruments :

 + faire confiance aux instruments, et non aux sensations
physiologiques

 + apprendre &agrave; se d&eacute;tendre pendant
le pilotage aux instruments

 + si le contr&ocirc;le de la situation devient douteux,
rester en ligne droite   et mettre les ailes &agrave; l'horizontale
  (revenir &agrave; l'horizon artificiel)
...
Instruments de radio-navigation :
 ...
 + r&eacute;cepteur de radio-balises
...
En vol :
  ...
  - noter les fr&eacute;quences de v&eacute;rification
de radio-navigation :

   _ VOR : - VOT   (&#177;4&#161; max)

     - 4&#161; max entre les deux VOR sur la m&ecirc;me
            station

     - point sp&eacute;cifi&eacute; de v&eacute;rification
au sol

     - synthoniser la premi&egrave;re station VOR
enroute          sur le receveur No. 2

   _ ADF : gisement avec - la radioborne ext&eacute;rieure

        - le NDB utilis&eacute; pour            l'approche

        - une station AM indiqu&eacute;e        
sur une carte VFR 

 + v&eacute;rification pendant le roulage :
...
D&eacute;monstration du &quot;vertige&quot; (d&eacute;sorientation
spatiale) :

 + d&eacute;f :  confusion entre ce que l'on voit
que les instruments indiquent et    ce que nos autres sens (toucher
et canaux semi-circulaires)    nous font ressentir 

 + demander &agrave; l'&eacute;l&egrave;ve de maintenir
le vol en palier rectiligne en ayant   les yeux ferm&eacute;s
(un mouvement brusque de la t&ecirc;te accentuera   l'effet) puis
de les rouvrir


Instruments de contr&ocirc;le, primaires et d'appui
:

 + de contr&ocirc;le :

  - indique comment amorcer la manoeuvre  (en voyant
quelle est          l'assiette actuelle)

  - r&eacute;f&eacute;rence centrale (celle qui revient
au d&eacute;but et &agrave; la fin de     chaque cycle de balayage
des instruments)

  - en panneau complet, il y en a deux : l'horizon
artificiel et le          tachym&egrave;tre

  - en panneau partiel, il y en a deux :   l'an&eacute;mom&egrave;tre
et le          coordonateur de virage

 + de performance primaires :

  - donnent l'information la plus pertinente sur
...
si on obtient la performance voulue)

  - donnent une indication constante (ne &quot;bouge&quot;
pas) lorsque la    manoeuvre est ex&eacute;cut&eacute;e de fa&ccedil;on
pr&eacute;cise

  - deviennent les instruments de contr&ocirc;le
en panneau partiel

 + de performance d'appui :

  - source additionelle d'information qui confirme
la performance   (&quot;back-up&quot;) qui aide &agrave; stabiliser
le vol et &agrave; &eacute;viter l'&quot;over-control&quot;

  - doivent &ecirc;tre utilis&eacute;s pour corroborer
...
des autres instruments
  ...
  - en panneau partiel, peuvent avoir &agrave; assumer
le r&ocirc;le des     instruments de contr&ocirc;le




Mont&eacute;es &agrave; vitesse constante
...
modifier assiette et puissance
...
obtenue :
  ...
  - modifier les deux &agrave; la fois
...
+ mise en virage en mont&eacute;e :
<TABLE BORDER=1>
<TR><TD WIDTH=148></TD><TD WIDTH=148>CONTROLE</TD><TD WIDTH=148>PRIMAIRE
</TD><TD WIDTH=148>D'APPUI</TD></TR>
<TR><TD WIDTH=148>tangage </TD><TD WIDTH=148>horizon art.</TD>
...
Consid&eacute;rations g&eacute;n&eacute;rales
...
de performance :
  ...
  - conservateur de cap magn&eacute;tique +  - -

Contr&ocirc;le de l'a&eacute;ronef
